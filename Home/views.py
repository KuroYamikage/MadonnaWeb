...
class indexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["pool1"] = Facility.objects.values_list(
            "id", "facilityPic", "facilityName"
        )
...
def reservations(request):
    ...
    ):  # it's not serialization, but extracting of the useful fields
        reserve_html.append(
            {
                "pk": instance.reservationID,
                "fname": instance.firstname,
                "lname": instance.lastname,
                "date": instance.date,
                "dp": instance.downpayment,
                "total": instance.totalPayment,
